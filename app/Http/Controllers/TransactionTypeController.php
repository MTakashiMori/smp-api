...
use App\Services\TransactionsTypeService;
use Exception;
use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\DB;

class TransactionTypeController extends MainController
{
    /**
     * @param PartyService $service
     */
    public function __construct(TransactionsTypeService $service)
    {
